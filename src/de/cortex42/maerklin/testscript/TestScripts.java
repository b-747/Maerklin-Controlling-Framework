...
public final class TestScripts {
    ...
    public static Script getTestScript(final ScriptContext scriptContext) throws FrameworkException {
        ...
        last = s.first = new ScriptElementSwitch(0x3000, 1); //Weiche 1 rechts //todo in english
        ...
        last = last.next = new ScriptElementSetVelocity(0x4006, MEDIUM_FAST); //Lok 6 fährt mittelschnell los
        last = last.next = new ScriptElementWaitForContact(0x110009, CS2CANCommands.EQUIPMENT_POSITION_ON); //Erreichen von Kontakt 9
        last = last.next = new ScriptElementSetVelocity(0x4006, FAST); //Lok 6 wird schnell
        ...
        last = last.next = new ScriptElementSetVelocity(0x4006, MEDIUM_FAST); //Lok 6 wird mittelschnell
        last = last.next = new ScriptElementWaitForContact(0x110007, CS2CANCommands.EQUIPMENT_POSITION_ON); //Erreichen von Kontakt 7
        last = last.next = new ScriptElementSetVelocity(0x4006, SLOW); //Lok 6 wird langsam
        last = last.next = new ScriptElementWaitForContact(0x110003, CS2CANCommands.EQUIPMENT_POSITION_ON); //Erreichen von Kontakt 3
        last = last.next = new ScriptElementSetVelocity(0x4006, STOP); //Lok 6 bleibt stehen
        ...
        last = last.next = new ScriptElementSetVelocity(0x4007, MEDIUM_FAST); //Lok 7 fährt mittelschnell los
        ...
        scriptElementConditionChecker1.next = new ScriptElementSetVelocity(0x4007, SLOW); //Lok 7 wird langsam
        ...
        temp.next = new ScriptElementSetVelocity(0x4007, STOP); //Lok 7 hält an
        ...
        scriptElementConditionChecker3.next = new ScriptElementSetVelocity(0x4005, STOP); //Lok 5 hält an
        ...
        last = last.next = new ScriptElementSetVelocity(0x4006, SLOW); //Lok 6 wird langsam
        last = last.next = new ScriptElementWaitForContact(0x110003, CS2CANCommands.EQUIPMENT_POSITION_ON); //Erreichen von Kontakt 3
        last.next = new ScriptElementSetVelocity(0x4006, STOP); //Lok 6 hält an
