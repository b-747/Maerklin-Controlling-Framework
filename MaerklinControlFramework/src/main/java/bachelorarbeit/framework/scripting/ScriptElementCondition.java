...
public class ScriptElementCondition extends ScriptElement {
    ...
    public ScriptElementCondition or(final ScriptElementCondition scriptElementCondition) throws ScriptElementConditionBooleanOperatorException {
        if (!(isOr || isAnd || isXor)) {
            ...
            throw new ScriptElementConditionBooleanOperatorException("Operator was already set.");
        }
    }

    public ScriptElementCondition and(final ScriptElementCondition scriptElementCondition) throws ScriptElementConditionBooleanOperatorException {
        if (!(isOr || isAnd || isXor)) {
            otherScriptElementCondition = scriptElementCondition;
            isAnd = true;
    ...
    public ScriptElementCondition xor(final ScriptElementCondition scriptElementCondition) throws ScriptElementConditionBooleanOperatorException {
        if (!(isOr || isAnd || isXor)) {
            otherScriptElementCondition = scriptElementCondition;
            isXor = true;
